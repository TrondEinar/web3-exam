...
namespace MmaAthletesApi
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.Configure<MmaAthleteDatabaseSettings>(
                Configuration.GetSection(nameof(MmaAthleteDatabaseSettings))
            );

            services.AddSingleton<IMmaAthleteDatabaseSettings>(
                sp => 
                    sp.GetRequiredService<IOptions<MmaAthleteDatabaseSettings>>().Value
            );
            ...
            {
                c.SwaggerDoc("v1", new OpenApiInfo { Title = "MmaAthletesApi", Version = "v1" });
            });
        }
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            if (env.IsDevelopment())
            {
                ...
                app.UseSwagger();
                app.UseSwaggerUI(c => c.SwaggerEndpoint("/swagger/v1/swagger.json", "MmaAthletesApi v1"));
            }
